...
const processSteps = [
  {
    id: 1,
    title: "Discovery",
    description: "Comprehensive analysis of requirements, market conditions, and strategic objectives to establish project foundation.",
    icon: Search,
    number: "01"
  },
  {
    id: 2,
    title: "Strategy",
    description: "Development of detailed roadmaps, architectural frameworks, and implementation methodologies tailored to your vision.",
    icon: Compass,
    number: "02"
  },
  {
    ...
    description: "Precision execution through systematic development cycles, rigorous testing, and continuous quality validation.",
    icon: Cog,
    number: "03"
  },
  {
    id: 4,
    title: "Excellence",
    description: "Seamless delivery with comprehensive documentation, knowledge transfer, and ongoing optimization protocols.",
    icon: CheckCircle,
    number: "04"
  }
]
    ...
    <section className="py-32 px-8 bg-white relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 1.4, ease: [0.23, 1, 0.320, 1] }}
        ...
        >
          <p className="text-lg text-gray-400 font-light tracking-wide max-w-xl mx-auto leading-relaxed">
            Every project follows this refined methodology, ensuring consistent excellence 
